...
Create archives of certificate chains
...
```
  -f, --config-file string   config file for bundler (default: bundle.yaml in current directory (default "bundle.yaml")
  -h, --help                 help for bundler
  -o, --output string        output directory for generated files (default "pkg")
```
