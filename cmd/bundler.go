...
var bundlerCommand = &cobra.Command{
	Use:   "bundler",
	Short: "Create archives of certificate chains",
	Long: `bundler creates archives of certificate chains from a YAML configuration
